...
public class HoughCircles {
    ...
    //info my
    private ArrayList<SpeedObject<Integer>> speedList = new ArrayList<SpeedObject<Integer>>();

    public boolean setParameters(Integer minRadius, Integer maxRadius, Integer incRadius,
                                 Integer circlesNumber, Integer threshold_) {
        radiusMin = minRadius;
        radiusMax = maxRadius;
        radiusInc = incRadius;
        depth = ((radiusMax - radiusMin) / radiusInc) + 1;
        maxCircles = circlesNumber;
    ...
    public ArrayList<SpeedObject<Integer>> getSpeedList() {
        return speedList;
    }
...
//        new ImagePlus(maxCircles + " Circles Found", circlesip).show();
    ...
    private void getCenterPoints(int maxCircles) {
        ...
        for (int c = 0; c < maxCircles; c++) {
            ...
            //info my
            speedList.add(new SpeedObject<Integer>(xMax, yMax, rMax, 0, 0));
